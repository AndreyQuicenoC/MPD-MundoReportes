...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write("=" * 60)
        self.stdout.write("Usuarios creados: {}".format(usuarios_creados))
        self.stdout.write("Usuarios ya existentes: {}".format(usuarios_existentes))
        self.stdout.write("Total de usuarios: {}".format(Usuario.objects.count()))
        self.stdout.write("")

        if usuarios_creados > 0:
            self.stdout.write("=" * 60)
            self.stdout.write("USUARIOS CREADOS EXITOSAMENTE")
            self.stdout.write("=" * 60)
            self.stdout.write("Los usuarios han sido creados en el sistema.")
            self.stdout.write("Se han enviado credenciales a los correos registrados.")
            self.stdout.write("")
