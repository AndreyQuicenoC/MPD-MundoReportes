...
const EstadisticasPreviewPDF = () => {
  ...
  const paletaColores = [
    '#9b933b', '#2563eb', '#dc2626', '#16a34a', '#f59e0b', '#8b5cf6',
    '#06b6d4', '#ec4899', '#6366f1', '#14b8a6', '#ca8a04', '#7c3aed',
  ];
              ...
              <table className="metrics-table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="metric-value">{formatearMoneda(estadisticas.promedio_ventas)}</td>
                    <td>Promedio por reporte ({estadisticas.total_reportes} reportes)</td>
                  </tr>
                  <tr>
                    <td className="metric-name">Total Gastos</td>
                    <td className="metric-value danger">{formatearMoneda(estadisticas.total_gastos)}</td>
                  ...
                  {deducibles.length > 0 && (
                    <>
                      <tr className="section-divider">
                        <td colSpan="3"><strong>Gastos Deducibles</strong></td>
                      </tr>
                      <tr>
                        <td className="metric-name">Ingresos Deducibles</td>
                        <td className="metric-value">${Number(gastosParaDeducir.ingreso).toLocaleString('es-CO')}</td>
                        <td>No restados del total</td>
                      </tr>
                      <tr>
                        <td className="metric-name">Ahorros Deducibles</td>
                        <td className="metric-value">${Number(gastosParaDeducir.ahorro).toLocaleString('es-CO')}</td>
                        <td>No restados del total</td>
                      </tr>
                      <tr>
                        <td className="metric-name">Transferencias Deducibles</td>
                        <td className="metric-value">${Number(gastosParaDeducir.transferencia).toLocaleString('es-CO')}</td>
                        <td>No restados del total</td>
                      </tr>
                      <tr className="highlight-row">
